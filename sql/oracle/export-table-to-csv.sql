...
CREATE OR REPLACE PROCEDURE export_table_to_csv
  (
    ...
    PC$EspaceEntetes in Varchar2 Default 'O'         -- Si 'O', remplace le caractere _ par un espace dans l'ent�te
  ) IS
...
When UTL_FILE.INTERNAL_ERROR then
  ...
  RAISE_APPLICATION_ERROR( -20070, LC$Msg ) ;
---------------------------------------------------------------
-- Les exceptions suivantes sont sp�cifiques � la version 9i --
-- A mettre en commentaire pour une version ant�rieure       --
---------------------------------------------------------------
...
When UTL_FILE.RENAME_FAILED Then
  ...
  RAISE_APPLICATION_ERROR( -20070, LC$Msg ) ;
-----------------------------------------------------------------
-- Les exceptions pr�c�dentes sont sp�cifiques � la version 9i --
--     mettre en commentaire pour une version ant�rieure       --
-----------------------------------------------------------------
When others Then
